                            ...
                            <Transition.Child
                                ...
                                <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all flex-col gap-5">
                                    ...
                                    <div className='flex-1 flex flex-col gap-2'>
                                        <h3 className='font-semibold text-xl capitalize'>{car.make} {car.model}</h3>
                                        <div className="mt-3 flex flex-wrap gap-4">
                                            {/* To get the keys aswell as the values, you need to pass the cars obhect into the Object.entries() function */}
